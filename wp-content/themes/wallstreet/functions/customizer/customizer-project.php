...
//Home project Section
	...
	//Project one link
    $wp_customize->add_setting(
        'wallstreet_pro_options[portfolio_post_id_one]',
        array(
            'default' => __('1','wallstreet'),
            'capability'     => 'edit_theme_options',
            'sanitize_callback' => 'sanitize_text_field',
            'type' => 'option'
            )	
    ...
    $wp_customize->add_control(
        'wallstreet_pro_options[portfolio_post_id_one]',
        array(
            'label' => __('Portfolio Post ID One','wallstreet'),
            'section' => 'project_one_section_settings',
            'type' => 'textarea',	
            )
        );
    ...
    //Project two link
    $wp_customize->add_setting(
        'wallstreet_pro_options[portfolio_post_id_two]',
        array(
            'default' => __('1','wallstreet'),
            'capability'     => 'edit_theme_options',
            'sanitize_callback' => 'sanitize_text_field',
    ...
    $wp_customize->add_control(
        'wallstreet_pro_options[portfolio_post_id_two]',
        array(
            'label' => __('Portfolio Post ID Two','wallstreet'),
            'section' => 'project_two_section_settings',
            'type' => 'textarea',   
            )
        );
    ...
    //Project three link
    $wp_customize->add_setting(
        'wallstreet_pro_options[portfolio_post_id_three]',
        array(
            'default' => __('1','wallstreet'),
            'capability'     => 'edit_theme_options',
            'sanitize_callback' => 'sanitize_text_field',
    ...
    $wp_customize->add_control(
        'wallstreet_pro_options[portfolio_post_id_three]',
        array(
            'label' => __('Portfolio Post ID Three','wallstreet'),
            'section' => 'project_three_section_settings',
            'type' => 'textarea',   
            )
        );
    ...
    //Project four link
    $wp_customize->add_setting(
        'wallstreet_pro_options[portfolio_post_id_four]',
        array(
            'default' => __('1','wallstreet'),
            'capability'     => 'edit_theme_options',
            'sanitize_callback' => 'sanitize_text_field',
    ...
    $wp_customize->add_control(
        'wallstreet_pro_options[portfolio_post_id_four]',
        array(
            'label' => __('Portfolio Post ID Four','wallstreet'),
            'section' => 'project_four_section_settings',
            'type' => 'textarea',   
            )
        );
