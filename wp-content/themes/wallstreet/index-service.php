...
<div class="container">
	...
	<div class="row">
		<div class="col-md-4 col-sm-6 service-effect">
			...
			<h2><a href="http://www.blog-musculation.fr/exercices/"><?php echo esc_html($current_options['service_title_one']); ?></a></h2>
			<?php } ?>
		...
		<div class="col-md-4 col-sm-6 service-effect">
			...
			<h2><a href="http://www.blog-musculation.fr/category/nutrition/"><?php echo esc_html($current_options['service_title_two']); ?></a></h2>
			<?php } ?>
		...
		<div class="col-md-4 col-sm-6 service-effect">
			...
			<h2><a href="http://www.blog-musculation.fr/category/conseils-et-decouvertes/"><?php echo esc_html($current_options['service_title_three']); ?></a></h2>
			<?php } ?>
